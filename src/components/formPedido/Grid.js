      ...
      <Tbody>
        {users.map((item, i) => (
         item.itens.map((itens, a) => ( 
          <Tr key={a}>
           <Td width="15%">{item.numero_pedido}</Td>
           <Td width="15%">{item.cliente_id}</Td>
           <Td width="15%">{item.nomeCliente}</Td>
           <Td width="15%">{itens.produto_id}</Td>
           <Td width="15%">{itens.nomeProduto}</Td>
           <Td width="15%">{itens.quantidade}</Td>
